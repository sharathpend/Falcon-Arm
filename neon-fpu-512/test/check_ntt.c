...
int compare_array_int(int16_t *a, int16_t *b, int bound)
{
    int16_t ca;
    for (int i = 0; i < bound; i++)
    {
...
void ntt_rewrite_inverse(int16_t a[FALCON_N])
{
...
int test_ntt(void)
{
    ...
    for (int k = 0; k < TESTS; k++)
    {
        ...
        mq_NTT(gold, FALCON_LOGN);
        ntt_rewrite_forward(test);
...
int test_invntt()
{
    ...
    for (int k = 0; k < TESTS; k++)
    {
        ...
        mq_iNTT(gold, FALCON_LOGN);
        ntt_rewrite_inverse(test);
